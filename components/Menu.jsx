...
const menu = [
    ...
    {
        img: '/menu/item-4.png',
        title: 'Orange and banana cookie',
        price: '$12.00',
    },
];
        ...
        <section className='relative py-12 xl:py-24 bg-menu' id="menu">
            <div className="container mx-auto">
                ...
                >
                    ...
                    <Link href='/' className='text-green flex justify-center xl:justify-end 
                        items-center mb-16'>
                        View All
                ...
                >
                    {menu.map((item, index) => (
                        <div key={index} className='max-w-[270px] bg-white shadow-primary 
                            mx-auto xl:mx-0 group'>
                            {/* img */}
                            <div className='overflow-hidden'>
                                <Image src={item.img} width={270} height={270} alt="menu"
